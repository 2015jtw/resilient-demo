const aboutData = {
  sectionOne: {
    title: "Getting started can be the hardest part",
    description: [
      "The COVID-19 pandemic was a wake-up call to leadership that preparedness matters. While the impacts of the pandemic were largely out of our control, there were a number of internal practices that may have limited the consequences. Our research suggests that the previous crisis had a significant influence on firms in preparing for future disruptions. ",
  ...
  sectionThree: {
    ...
    description: [
      ...
      "Resilient, LLC is a nontraditional advisory service focused on guiding boards and executive teams to appropriately develop risk and crisis management strategies. It is our goal to assist you in developing a set of policies and practices that better prepare your team for the inevitable crises that visit all of us at some point. We recognize that every organization has a distinct culture, risk environment, and leadership style that will influence the manner in which crisis preparedness or response is governed. Strategies are collaboratively developed with your organization to ensure a sustained effort. We can assist you if you are in the midst of a crisis, however we would much rather have a conversation “left of boom!”.",
    ],
  },
};
